    ...
    class UseItemPatch
    {
            ...
            [HarmonyArgument(2)] bool fromInventoryGui, Inventory ___m_inventory, ZSyncAnimation ___m_zanim)
        {
            ...
            if (itemName.Contains("$item_trophy_"))
            {
                ...
                // Emrik: If the randomSkill is 1337, reroll it until it ISN'T 1337.
                while (randomSkill.ToString() == "1337")
                {
                    randomSkill = skills[UnityEngine.Random.Range(0, skills.Count)].m_info.m_skill;
                }
